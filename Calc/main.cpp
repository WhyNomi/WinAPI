...
double a = 0, b = 0;
CHAR sz_buffer[N_BUFFER_SIZE]{}; //main 
CHAR sz_buffer_a[N_BUFFER_SIZE]{}; // значение операнда а
CHAR sz_buffer_b[N_BUFFER_SIZE]{}; // значение операнда б
CHAR s;
...
BOOL CALLBACK DlgProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	switch (uMsg)
	{
		...
		case  IDC_BUTTON_POINT:SendMessage(GetDlgItem(hwnd, IDC_EDIT1), WM_CHAR, VK_OEM_PERIOD, 0);break;
